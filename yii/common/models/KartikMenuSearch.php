...
/**
 * KartikMenuSearch represents the model behind the search form of `common\models\KartikMenu`.
 */
class KartikMenuSearch extends KartikMenu
{
    /**
     * {@inheritdoc}
     */
